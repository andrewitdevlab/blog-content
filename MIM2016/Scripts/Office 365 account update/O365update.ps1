#O365update.ps1 - script from: https://learn.microsoft.com/en-us/microsoft-identity-manager/microsoft-identity-manager-2016-gmsascript
...
if($isManaged)
{
    ...
    # Update the Client Secret registry entry as well (name taken from: https://oxfordcomputergroup.com/resources/mim-set-credentials-parameters-no-installation-disc/)
    Set-ItemProperty -Path HKLM:"\SOFTWARE\Microsoft\Forefront Identity Manager\2010\Service" -Name EncryptedExchangeOnlineClientSecret -Value $encryptedData
}
else
{
